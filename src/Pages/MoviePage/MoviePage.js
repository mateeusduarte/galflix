import { FlexCastGenreDirector, FlexContent, FlexDateTime, FlexRate, InfoContainer, MoviePageContainer, PlotContainer, TitleContainer, BackIcon } from "./styled-MoviePage";
            ...
            <FlexContent>
                ...
                <FlexRate>
                    <div>
                        ...
                        <p>{states.movieDetail.Ratings ? (states.movieDetail.Ratings[0] ?states.movieDetail.Ratings[0].Value : "None"):"None"}</p>
                    </div>
                    <div>
                        <img src="https://pbs.twimg.com/profile_images/1145693812464816128/9ZMAMaoT_400x400.png"/>
                        <p>{states.movieDetail.Ratings ? (states.movieDetail.Ratings[1] ?states.movieDetail.Ratings[1].Value : "None"):"None"}</p>
                    </div>
                    <div>
                        {functions.renderLikedHeart(pathParams.id)}
                    </div>
                    
                </FlexRate>
                <PlotContainer>
                        <p><strong>Enredo</strong><br></br><br></br>{states.movieDetail.Plot}</p>
                </PlotContainer>
